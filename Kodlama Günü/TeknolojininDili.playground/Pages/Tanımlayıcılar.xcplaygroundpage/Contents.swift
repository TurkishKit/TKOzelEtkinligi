...
let toplamHayvanSayisi = kopeklerinSayisi + kedilerinSayisi + kaplumbagalarinSayisi + hamsterlarinSayisi
...
//:
//:[Geri](@previous)  |  Sayfa 12 / 15  |  [İleri: İyi İsimler Seçmek](@next)
